// scratch/live_posts_batch1.mjs

export const livePostsBatch1 = [
  // ─── 1. SSC CGL 2026 Top-10 FAQ Master Guide ───
  {
...
Target Safe Zone (UR/OBC): 76+ Attempts with 90% Accuracy → ~146–152 Net Raw Marks</code></pre>
  ...
  // ─── 2. RRB NTPC 2026 Top-10 FAQ Master Guide ───
  {
    ...
    quickFacts: [
      { label: "Conducting Agency", value: "Railway Recruitment Boards (RRBs)" },
      { label: "Post Categories", value: "Graduate (Levels 5-6) & Undergrad (Levels 2-3)" },
...
Percentile Normalization adjusts for difficulty variances across multi-day shifts.</code></pre>
  ...
  // ─── 3. IBPS PO 2026 Top-10 FAQ Master Guide ───
  {
    ...
    quickFacts: [
      ...
      { label: "Participating Banks", value: "11 Public Sector Banks (PNB, BoB, Canara, etc.)" },
      { label: "Application Last Date", value: "October 20, 2026" },
      { label: "Selection Stages", value: "Prelims + Mains + Personal Interview" },
      { label: "Final Merit Weight", value: "80% Mains Score + 20% Interview Score" },
      { label: "Document Specs", value: "Photo (20-50KB), Sign (10-20KB), Thumb (20-50KB), Declaration (50-100KB)" }
    ],
    contentHtml: `
      <section id="overview" class="space-y-4">
  ...
  // ─── 4. SBI Clerk 2026 Top-10 FAQ Master Guide ───
  {
    ...
    quickFacts: [
      ...
      { label: "Designation", value: "Junior Associate (Customer Support & Sales)" },
      { label: "Selection Stages", value: "Prelims + Mains + Local Language Test (LPT)" },
      { label: "Sectional Cut-offs", value: "NONE (Aggregate Marks Only)" },
      { label: "State Selection", value: "Strictly ONE State / UT only" },
      { label: "Document Specs", value: "Photo (20-50 KB) + Signature (10-20 KB)" }
    ],
    contentHtml: `
      <section id="overview" class="space-y-4">
...
console.log('Batch 1 written. Contains 4 complete posts.');
